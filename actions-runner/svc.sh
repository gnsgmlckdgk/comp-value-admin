...
SVC_NAME="actions.runner.gnsgmlckdgk-comp-value-admin.hwangchanghaui-MacBookPro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (gnsgmlckdgk-comp-value-admin.hwangchanghaui-MacBookPro)"
